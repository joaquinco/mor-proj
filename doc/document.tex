...
\begin{document}
  ...
  Para calibrar los primeros, se consideraron combinaciones de valores de dichos parámetros que suman 1 y se ejecutaron todas las instancias de prueba. Para determinar las combinaciones, se consideraron valores en el intervalo $[0, 1)$ espaciados cada $0.1$. Esto devino en 18 posibles configuraciones que fueron ejecutadas en el cluster.

  Como alternativa, se pudo haber hecho un estudio de las variables finales de las ejecuciones de CPLEX.
