...
\begin{document}
  ...
  OPT2 logró una mejora en las soluciones respecto a la fase de construcción en todos los casos como se detallará en la sección de resultados. Sin embargo habían casos en que esta transformación no era suficiente, las soluciones eran parecidas a las óptimas a menos de algunos clientes que debían ser movidos de una ruta a otra.

  \subsubsection*{Insertion}

  Para contemplar algunas falencias de OPT2, se implementó la búsqueda que llamaremos Insertion. Lo que hace es dada dos rutas A y B, intenta insertar un cliente de A en B.
